...
## simulation
The simulation which corresponds to the environment in RL framework runs on MATLAB RCWA open source [Reticolo](https://zenodo.org/record/3610175#.YBkECS2UGX0) and is borrowed from [Jonathan Fan group GLOnet github](https://github.com/jonfanlab/GLOnet).
