...
gamma         = 0.99 #0.98
buffer_limit  = int(1e5)  #### 늘려야함!!!!!!!!!!!!!!!!   ####
batch_size    = 32
n_cells = 64
tau = 0.1
episode_length = n_cells * 2
EpisodeNumber = 40000
print_interval = 50
n_step_decreasing_period = 1000
...
def main():tor-v0')
    ...
    for n_epi in range(EpisodeNumber):
        ...
        for t in range(episode_length):
            epsilon = max(0.01, 0.9 * (1. - count / n_step_decreasing_period))
            q.eval()
            ...
            if count % merge_step == 0:
                ...
                merge_network_weights(q_target.named_parameters(),
